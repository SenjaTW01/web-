					...
					<div class="grid grid-cols-2 sm:grid-cols-3">
						<div className=" ">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://instagram.com/senj444__?igshid=YTQwZjQ0NmI0OA==" class="hover:underline">
										Senj444
									</a>
								</li>
								<li>
									<a href="https://instagram.com/snj.cpp?igshid=NGVhN2U2NjQ0Yg==" class="hover:underline">
										SenBaik		
									</a>
								</li>
							</ul>
						...
						<div className="">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://instagram.com/official_spyware?igshid=MzRlODBiNWFlZA==" class="hover:underline ">
										Instagram
									</a>
								</li>
								<li>
				...
				<div class="sm:flex sm:items-center sm:justify-between">
					<div class="flex mt-4 justify-center sm:mt-0">
						<p className="text-[0.7rem] text-white opacity-70">
							© {new Date().getFullYear()} Kelas XI PPLG | Di Kembangkan Oleh Siswa SPYWARE
						</p>
					</div>
				</div>
			</div>
